module github.com/NishLy/go-fiber-boilerplate
...
require (
	...
	github.com/gofiber/contrib/v3/websocket v1.1.3 // indirect
...
require (
	ariga.io/atlas v1.2.1-0.20260414005238-df19880124d4 // indirect
